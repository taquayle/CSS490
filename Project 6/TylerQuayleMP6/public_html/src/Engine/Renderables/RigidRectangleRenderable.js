/*
 * File: RigidRectangleRenderable.js
 *  
...
function RigidRectangleRenderable() {
...
gEngine.Core.inheritPrototype(RigidRectangleRenderable, Renderable);
...
RigidRectangleRenderable.eTexCoordArray = Object.freeze({
    eLeft: 2,
    eRight: 0,
    eTop: 1,
    eBottom: 5
...
RigidRectangleRenderable.prototype.setElementUVCoordinate = function (left, right, bottom, top) {
    this.mTexLeft = left;
...
RigidRectangleRenderable.prototype.setElementPixelPositions = function (left, right, bottom, top) {
...
RigidRectangleRenderable.prototype.getElementUVCoordinateArray = function () {
    return [
...
RigidRectangleRenderable.prototype.draw = function (aCamera) {
