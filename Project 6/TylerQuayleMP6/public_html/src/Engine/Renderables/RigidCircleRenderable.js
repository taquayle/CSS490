...
function RigidCircleRenderable() {
...
gEngine.Core.inheritPrototype(RigidCircleRenderable, Renderable);
...
RigidCircleRenderable.eTexCoordArray = Object.freeze({
    eLeft: 2,
    eRight: 0,
    eTop: 1,
    eBottom: 5
...
RigidCircleRenderable.prototype.setElementUVCoordinate = function (left, right, bottom, top) {
    this.mTexLeft = left;
...
RigidCircleRenderable.prototype.setElementPixelPositions = function (left, right, bottom, top) {
...
RigidCircleRenderable.prototype.getElementUVCoordinateArray = function () {
    return [
...
RigidCircleRenderable.prototype.draw = function (aCamera) {
