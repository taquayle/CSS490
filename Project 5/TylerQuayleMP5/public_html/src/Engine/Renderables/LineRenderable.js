...
LineRenderable.prototype.getSecondVertex = function () {
    return [this.mP2[0],this.mP2[1]];
};
LineRenderable.prototype.getFirstVertex = function () {
    return [this.mP1[0],this.mP1[1]];
};
