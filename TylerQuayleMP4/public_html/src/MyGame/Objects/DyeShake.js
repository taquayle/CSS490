...
function DyeShake(state, xDelta, yDelta, shakeFrequency, shakeDuration) {
...
DyeShake.prototype.updateShakeState = function () {
    var s = this.mShake.getShakeResults();
    vec2.add(this.mShakeCenter, this.mOrgCenter, s);
};

DyeShake.prototype.shakeDone = function () {
    return this.mShake.shakeDone();
};

DyeShake.prototype.getCenter = function () { return this.mShakeCenter; };
DyeShake.prototype.setRefCenter = function (c) {
